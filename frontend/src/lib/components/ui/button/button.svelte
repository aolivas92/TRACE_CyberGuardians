	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				secondary:
					'bg-background2 text-foreground hover:bg-background3 hover:text-background2-foreground data-[active=true]:bg-accent data-[active=true]:text-background',
				ghost: 'text-primary',
				link: 'text-primary underline-offset-4 hover:underline',
				circle:
					'bg-background2 text-background2-foreground hover:bg-background3 hover:text-background2-foreground rounded-full drop-shadow-md data-[active=true]:bg-accent data-[active=true]:text-background'
			},
			size: {
