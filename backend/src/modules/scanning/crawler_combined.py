...
crawler_manager.configure_crawler(target_url="http://example.com", depth=2, limit=100, user_agent="Mozilla/5.0", delay=1, proxy="")

crawler_manager.start_crawl()
raw_content = "Here are some URLs: http://example1.com http://example2.com"
...
if processed_data:
    ...
    crawler_manager.save_results("http://exampleapi.com")
